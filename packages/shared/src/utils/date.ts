 ...
 * - YYYYMMDD (e.g., "20250114") - Database and API format
 * - YYYY-MM (e.g., "2025-01") - Usage tracking format
 */

/**
 * Get current date in YYYYMMDD format
 *
 * @returns Current date string (e.g., "20250114")
 */
 ...
 *
 * Used for monthly usage tracking.
 *
